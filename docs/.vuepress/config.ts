...
import { bgmMusicPlayer } from '../../packages/@anyfork/vuepress-plugin-bgm-player-next'
import { loadingPage } from '../../packages/@anyfork/vuepress-plugin-loading-page-next'
export default defineUserConfig({
  ...
  theme: defaultTheme({
    logo: "https://cdn.staticaly.com/gh/AnyFork/blog-images/main/markdown/202208241822713.png"
  }),
  markdown: {
    headers: {
      level: [1, 2, 3, 4],
