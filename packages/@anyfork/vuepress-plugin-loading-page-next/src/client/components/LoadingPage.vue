<template>
  <div id="loader-wrapper">
    <h3 class="title" v-if="frontmatter.home">{{ siteData.title || frontmatter.title }}</h3>
    <p class="description" v-if="frontmatter.home">{{ siteData.description || frontmatter.description }}</p>
